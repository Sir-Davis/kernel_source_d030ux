...
#if defined(CONFIG_PROJECT_S5030_PK)
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "QMobile i6i",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "BLU Dash X",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "CloudFone ExciteC",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Advance 5.0",
	{  },	/* end of list */
};
#else
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "BLU Dash M",
	{  },	/* end of list */
};
#endif

#elif defined(CONFIG_PROJECT_S5250_MMX_IN)
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Micromax Q338",
	{  },	/* end of list */
};
#elif defined(CONFIG_PROJECT_S5030_MMX_IN)
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Micromax Q334",
	{  },	/* end of list */
};
#else
static struct usb_string mtp_string_defs[] = {
