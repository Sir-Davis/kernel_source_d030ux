...
#if defined(CONFIG_PROJECT_S5250_MMX_IN)
#define MANUFACTURER_STRING "Micromax"
#define PRODUCT_STRING "Q338"

#elif defined(CONFIG_PROJECT_S5030_PK)
#define MANUFACTURER_STRING "QMobile"
#define PRODUCT_STRING "i6i"

#elif defined(CONFIG_PROJECT_S5250_PK)
#define MANUFACTURER_STRING "QMobile"
#define PRODUCT_STRING "S2"

#elif defined(CONFIG_PROJECT_S5030_MCL_ZA)
#define MANUFACTURER_STRING "Mobicel"
#define PRODUCT_STRING "VIVO"

#elif defined(CONFIG_PROJECT_S5030_MMX_IN)
#define MANUFACTURER_STRING "Micromax"
#define PRODUCT_STRING "Q334"

#elif defined(CONFIG_PROJECT_S5250_BLU_US)
#define MANUFACTURER_STRING "BLU"
#define PRODUCT_STRING "Dash X"

#elif defined(CONFIG_PROJECT_S5030_BLU_US)
#define MANUFACTURER_STRING "BLU"
#if  defined(CONFIG_PROJECT_S5030_BLU_YMX_US)
#define PRODUCT_STRING "Advance 5.0"
#else
#define PRODUCT_STRING "Dash M"
#endif
#elif defined(CONFIG_PROJECT_S5030_CEL_TN)
#define MANUFACTURER_STRING "EVERTEK"
#define PRODUCT_STRING "EverGlory II"

#elif defined(TINNO_WIKO_FR_PRJ) || defined(CONFIG_PROJECT_WIKO_UNIFY)
 #if defined(CONFIG_TINNO_WIKO_VN_PRJ)
#define MANUFACTURER_STRING "WIKO"
#define PRODUCT_STRING "RAINBOW JAM"
#else
#define MANUFACTURER_STRING "LENNY2"
#define PRODUCT_STRING "LENNY2"
#endif

#elif defined(CONFIG_PROJECT_S5030_KNB_MM)
#define MANUFACTURER_STRING "KENBO"
#define PRODUCT_STRING "E71"

#elif defined(CONFIG_PROJECT_S5030_LAX_CLA_CO)
#define MANUFACTURER_STRING "LANIX"
#define PRODUCT_STRING "Ilium X500B"

#elif defined(CONFIG_PROJECT_S5030_CLF_PH)
#define MANUFACTURER_STRING "CloudFone"
#define PRODUCT_STRING "ExciteC"
